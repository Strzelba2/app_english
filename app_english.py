        ...
        def add_USER():
            ...
            if self.User1  not in list(USERDANE) and MARKS >=1 and  LETER >= 1 and self.passw1 == self.passw2 and EMAILCOUNT ==0:
                ...
                try:
                    ...
                    server.ehlo()
                    server.starttls()
                    server.login('english.ward.app@gmail.com' , '#')
                ...
                if User in list(USERDANE):
                        ...
                        if email == userval[2]:
                                ...
                                try:
                                        ...
                                        server.ehlo()
                                        server.starttls()
                                        server.login('english.ward.app@gmail.com' , 'Polska.21')
...
#=======================================POWTÓRKI===================================================================================
        ...
        self.frame2.place(relwidth = 0.28 , relheight = 1)
        def powtorki():
            USERWARD = pickle.load(open("USERWARD.py" , "rb"))
            USERDANE = pickle.load(open("USERDANE.py" , "rb"))
            uservalue = USERWARD[self.User]
                        ...
                        if date <= self.today:
                                ...
                                if len(uservalue) <5:
                                        ...
                                        for g in range(0,4):
                                                ...
                                                btn[g]["command"] = lambda x = eng_sample[g] : add_value(x) 
                                        ...
                                        btn[randomRef]["command"] = lambda x = uservalue[i][1] : add_value(x) 
                                ...
                                for a in range(0,4):
                                        ...
                                        btn[a]["command"] = lambda x = uservalue[count[a]][1] : add_value(x) 
                    ...
                    try:    
                        if date <= self.today:
                                ...
                                if len(uservalue) < 5:
                                        ...
                                        btn[randomRef]["text"] = word2
                                        btn[randomRef]["command"] = lambda x = uservalue[i][0] : add_value(x) 
                                ...
                                for g in range(0,4):
                                        ...
                                        btn.append(Button(frame21 ,font = ('arial' , 18 , 'bold') , bd=2 ,bg='white', relief='ridge' , text = word3))
                                        btn[g].place(relwidth = 0.9 , relheight = 0.1 ,relx=0.05 , rely = 0.20+(g*0.1))
                                        btn[g]["command"] = lambda x = uservalue[count[g]][0] : add_value(x) 
                                        btn[g].configure(bg ='white')
                ...
                for i in range(len(uservalue)):
                    ...
                    try:    
                        if date <= self.today:
                                                ...
                                                for ind , word in enumerate(polword_split):
                                                        ...
                                                        if correct_word >0:
                                                                ...
                                                                if ind==0:
                                                                        ...
                                                                        print("len word = " ,len(polword_split[ind]) )
                                                                        print (lengh_word)
                                ...
                                Ent_Pol.bind('<Return>' ,Chuck_word )
                                Ent_Pol.focus()
                                break
                ...
                for i in range(len(uservalue)):
                        ...
                        try:
                                if date <= self.today:
                                        ...
                                        ze_S_ENG.bind('<Return>' ,Chuck_word_ze_S )
                                        ze_S_ENG.focus()
...
#======================================================FIND WORD===================================================
            ...
            for  i in range(0,len(uservalue)):
                ...
                if 1< uservalue[i][4].count('NAUCZONE') < 8:
